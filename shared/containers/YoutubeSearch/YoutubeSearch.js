        ...
        <Col md={24} sm={24} xs={24} style={colStyle}>
          {youtubeSearchApi ? (
            <Box style={{ minHeight: 220 }}>
              <InputSearch placeholder="Search on Youtube" defaultValue={YoutubeSearch.searcText} onSearch={onSearch} />
              <YoutubeResult YoutubeSearch={YoutubeSearch} onPageChange={handlePageChange} />
            </Box>
          ) : (
            <NoAPIKey />
          )}
