...
const Timeline = {
  ...
  rows: [
    ["1", "Washington", new Date("1789-04-29T18:00:00.000Z"), new Date("1797-03-03T18:00:00.000Z")],
    ["2", "Adams", new Date("1797-03-03T18:00:00.000Z"), new Date("1801-03-03T18:00:00.000Z")],
    ["3", "Jefferson", new Date("1801-03-03T18:00:00.000Z"), new Date("1809-03-03T18:00:00.000Z")],
  ],
  options: {
...
const Gantt = {
  ...
  rows: [
    ...
    ["Write", "Write paper", null, new Date("2015-01-08T18:00:00.000Z"), 259200000, 25, "Research,Outline"],
    ["Cite", "Create bibliography", null, new Date("2015-01-06T18:00:00.000Z"), 86400000, 20, "Research"],
    ["Complete", "Hand in paper", null, new Date("2015-01-09T18:00:00.000Z"), 86400000, 0, "Cite,Write"],
    ["Outline", "Outline paper", null, new Date("2015-01-05T18:00:00.000Z"), 86400000, 100, "Research"],
  ],
  options: {
    tooltip: {
      textStyle: {
