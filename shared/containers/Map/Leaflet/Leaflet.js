      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
        ...
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box title={<IntlMessages id="Map.leaflet.leafletCustomMarkerTitle" />}>
            <ContentHolder>
              <LeafletMap id="map-with-custom-icon" customIconMarkerList={customIconMarkers} />
            </ContentHolder>
          </Box>
        </Col>
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box title={<IntlMessages id="Map.leaflet.leafletCustomHtmlMarkerTitle" />}>
            <ContentHolder>
              <LeafletMap id="map-with-custom-markers" htmlMarkerList={customHtmlMarker} />
            </ContentHolder>
          </Box>
        </Col>
      </Row>
