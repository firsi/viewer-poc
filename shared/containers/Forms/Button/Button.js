        ...
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box title={<IntlMessages id="forms.button.simpleButton" />}>
            <ContentHolder>
              ...
              <Button danger>{<IntlMessages id="forms.button.simpleButtonDangerText" />}</Button>
            </ContentHolder>
          </Box>
        </Col>
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box title={<IntlMessages id="forms.button.iconButton" />}>
            <ContentHolder>
              <Button type="primary" shape="circle" icon={<SearchOutlined />} style={margin} />
              ...
              <Button icon={<SearchOutlined />}>{<IntlMessages id="forms.button.iconSimpleButton" />}</Button>
            </ContentHolder>
            ...
            <ContentHolder>
              ...
              <Button type="dashed" shape="circle" icon={<SearchOutlined />} style={margin} />
      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box title={<IntlMessages id="forms.button.SizedButton" />}>
            ...
            <ContentHolder>
              <Button type="primary" shape="circle" icon={<DownloadOutlined />} size={size} style={margin} />
              <Button type="primary" icon={<DownloadOutlined />} size={size} style={margin}>
                Download
              </Button>
      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box title={<IntlMessages id="forms.button.LoadingButton" />}>
            ...
            <ContentHolder>
              <Button type="primary" loading={loading} onClick={enterLoading} style={margin}>
                Click me!
              </Button>
              <Button type="primary" icon={<PoweroffOutlined />} loading={iconLoading} onClick={enterIconLoading}>
                Click me!
              </Button>
            </ContentHolder>
