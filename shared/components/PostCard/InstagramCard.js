...
const InstagramCard = ({ key, type, image, numberOfView, numberOfcomment, numberOflike, onClick, className }) => {
  return (
    <CardWrapper className={`post-card instagram ${className ? className : ""}`} key={key} onClick={onClick}>
