...
export const SinglePageLoader = (props) => {
  return (
    <ContentLoader height={1000} width={800} speed={3} primaryColor="#f3f3f3" secondaryColor="#e9e8ec" {...props}>
...
export const HotelPostGridLoader = (props) => {
  return (
    <ContentLoader height={400} width={400} speed={2} primaryColor="#f3f3f3" secondaryColor="#e9e8ec" {...props}>
...
export const ProfilePicLoader = () => (
  <ContentLoader height={180} width={180} speed={3} primaryColor="#f3f3f3" secondaryColor="#ecebeb">
...
export const ImageCardLoader = () => (
  <ContentLoader height={270} width={215} speed={2} primaryColor="#f3f3f3" secondaryColor="#ecebeb">
